...
import type { OnboardingStep } from '@/apis/onboarding.api';
...
export function AdminApprovalStep({ step }: Props) {
    ...
    <div className="space-y-8 text-center">
      ...
      {support && (
        <div className="rounded-xl border bg-muted/50 p-6">
          <p className="mb-4 text-sm text-muted-foreground">{support.message}</p>
          <a
            href={support.whatsapp.url}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2.5 rounded-lg bg-[#25D366] px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-[#20BD5A]"
          >
      ...
      <div className="mx-auto max-w-sm text-left">
        ...
        <div className="space-y-3">
          {[
            ...
            'Access your full dashboard & API keys',
          ].map((text, i) => (
